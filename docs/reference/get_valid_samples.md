...
``` r
get_valid_samples(input, subject_ids, min_cells, verbose = 0)
```
...
This function inspects the metadata to ensure there are at least 3
samples with min_cells. If this condition is not satisfied, the function
